     ...
     <form role="form" method="POST" enctype="multipart/form-data">
        <div class="box-body">
          <div class="form-group">
            ...
            <input type="text" class="form-control" id="exampleInputName" name="user" placeholder="User name">
          </div>
          <div class="form-group">
            <label for="exampleInputPrice">Email</label>
            <input type="text" class="form-control" id="exampleInputPrice" name="email" placeholder="Email ">
          </div>
          <div class="form-group">
            <label for="exampleInputHDH">Password</label>
            <input type="password" class="form-control" id="exampleInputHDH" name="pass" placeholder="PassWord">
          </div>
          <div class="form-group">
            <label for="exampleInputCPU">Re-Password</label>
            <input type="password" class="form-control" id="exampleInputCPU" name="re-pass" placeholder="Re-PassWord">
          </div>
          <div class="form-group">
            <label for="exampleInputRam">Phone</label>
            <input type="text" class="form-control" id="exampleInputRam" name="phone" placeholder="Phone">
          </div>
          <div class="form-group">
            <label for="exampleInputRom">Address</label>
            <input type="text" class="form-control" id="exampleInputRom" name="address" placeholder="Address">
          </div>
          <div class="form-group">
      ...
      <?php
        if(!isset($_POST['submit'])) {
          ...
          if($user && $email && $pass && $re_pass && $phone && $address && $pass == $re_pass){
            ...
            if(mysql_numrows($query) > 0){
              ...
              $addmember = mysql_query("INSERT INTO `user` (`name_user`, `email_user`, `pass_user`, `phone_user`, `address_user`, `avatar`, `permissions`) VALUES ('$user', '$email', '$pass', '$phone', '$address', '$hinh', 'level')");
            }
          }
          else {
